...
export async function getListPosts(){
  ...
  const endpoint =  'http://localhost:3000/api/v0/posts';
  const response =  await fetch(endpoint).then((e)=>e.json());

  return response;
}

export async function getListStories(){
  
  const endpoint =  'http://localhost:3000/api/v0/stories';
  const response =  await fetch(endpoint).then((e)=>e.json());
...
export async function getProfile(){
  ...
  const endpoint =  'http://localhost:3000/api/v0/profile';
  const response =  await fetch(endpoint).then((e)=>e.json());
...
export async function getSuggestions(){
  ...
  const endpoint =  'http://localhost:3000/api/v0/suggestions';
  const response =  await fetch(endpoint).then((e)=>e.json());
